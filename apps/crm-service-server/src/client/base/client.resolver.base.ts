...
export class ClientResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Ip], { name: "ips" })
  @nestAccessControl.UseRoles({
    resource: "Ip",
    action: "read",
    possession: "any",
  ...
  async findIps(
    @graphql.Parent() parent: Client,
    @graphql.Args() args: IpFindManyArgs
  ): Promise<Ip[]> {
    const results = await this.service.findIps(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Vm], { name: "vms" })
  @nestAccessControl.UseRoles({
    resource: "Vm",
    action: "read",
    possession: "any",
  ...
  async findVms(
    @graphql.Parent() parent: Client,
    @graphql.Args() args: VmFindManyArgs
  ): Promise<Vm[]> {
    const results = await this.service.findVms(parent.id, args);
