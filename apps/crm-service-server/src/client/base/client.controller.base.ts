...
import { IpFindManyArgs } from "../../ip/base/IpFindManyArgs";
import { Ip } from "../../ip/base/Ip";
import { IpWhereUniqueInput } from "../../ip/base/IpWhereUniqueInput";
import { VmFindManyArgs } from "../../vm/base/VmFindManyArgs";
import { Vm } from "../../vm/base/Vm";
...
export class ClientControllerBase {
  ...
  async findIps(
    ...
    const query = plainToClass(IpFindManyArgs, request.query);
    const results = await this.service.findIps(params.id, {
      ...query,
      select: {
        address: true,
  ...
  async connectIps(
    @common.Param() params: ClientWhereUniqueInput,
    @common.Body() body: IpWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      ips: {
        connect: body,
  ...
  async findVms(
    ...
    const query = plainToClass(VmFindManyArgs, request.query);
    const results = await this.service.findVms(params.id, {
      ...query,
      select: {
        client: {
          select: {
  ...
  async connectVms(
    @common.Param() params: ClientWhereUniqueInput,
    @common.Body() body: VmWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      vms: {
        connect: body,
