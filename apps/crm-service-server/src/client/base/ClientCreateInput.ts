...
class ClientCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => IpCreateNestedManyWithoutClientsInput,
  })
  @ValidateNested()
  @Type(() => IpCreateNestedManyWithoutClientsInput)
  @IsOptional()
  @Field(() => IpCreateNestedManyWithoutClientsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => VmCreateNestedManyWithoutClientsInput,
  })
  @ValidateNested()
  @Type(() => VmCreateNestedManyWithoutClientsInput)
  @IsOptional()
  @Field(() => VmCreateNestedManyWithoutClientsInput, {
    nullable: true,
  })
